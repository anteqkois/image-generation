    ...
    messages: [
      {
        role: "system",
        content:
          "You are trained to describe images in clear way. Response with sentences, not structures like lists etc. Don't include any 'Parental Advisory' sign/information",
      },
      {
        role: "user",
        content: [
